...
// ConfigManager handles persistent configuration operations.
...
func (cm *ConfigManager) LoadConfig(k8sRESTConfig *rest.Config) error {
...
func (cm *ConfigManager) GetCurrentClusterConfig() (*ClusterConfig, error) {
...
func (cm *ConfigManager) GenerateClusterName() (string, error) {
...
func (cm *ConfigManager) RemoveClusterConfigByName(clusterName string) error {
	if clusterName == "" {
...
func (cm *ConfigManager) ListClusters() map[string]*ClusterConfig {
	return cm.config.Clusters
}

func (cm *ConfigManager) AddCluster(cluster *ClusterConfig) {

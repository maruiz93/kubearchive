...
echo "Building kubectl-archive for linux/amd64..."
GOOS=linux GOARCH=amd64 go build -ldflags "${LDFLAGS}" -o ./cli-binaries/kubectl-archive-linux-amd64 ./cmd/kubectl-archive/

echo "Building kubectl-archive for linux/arm64..."
GOOS=linux GOARCH=arm64 go build -ldflags "${LDFLAGS}" -o ./cli-binaries/kubectl-archive-linux-arm64 ./cmd/kubectl-archive/
...
gh release create "${NEXT_VERSION}" \
    ...
    kubearchive.yaml \
    ./cli-binaries/kubectl-archive-linux-amd64 \
    ./cli-binaries/kubectl-archive-linux-arm64
rm ./release-notes.md
rm ./kubearchive.yaml
rm -rf ./cli-binaries
